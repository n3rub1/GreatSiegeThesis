...
public class SubmitUserFeedbackPostMidQuestions : MonoBehaviour
{

    //https://docs.google.com/forms/u/0/d/e/1FAIpQLSczc3oU4xMFG7Y6qThLmPkFqU6guKb5xYEXjnOE9HBVamjwPQ/formResponse MID POST CONTROL NO PRE
    //https://docs.google.com/forms/u/0/d/e/1FAIpQLScOhPGqiue3VRDCTM6vPErgD0QPtHppbp3g9Vt4oJrGJjxEOg/formResponse MID POST IDN NO PRE

    //https://docs.google.com/forms/u/0/d/e/1FAIpQLSc70aak-e2BGtuGs4SJDMwRJkW7mZZZZguFZUagRU9IQUPsRA/formResponse MID POST CONTROL WITH PRE
    //https://docs.google.com/forms/u/0/d/e/1FAIpQLSfTj3OotVpsQp3KwuWfiqYrI9kowJB0FzGk7E8CQhwkU0IgMg/formResponse MID POST IDN WITH PRE
    ...
    private IEnumerator Post(List<string> answers)
    {
        ...
        if (isTextPostIDNPost) URLIndex = 0;
        if (isIDNPostTextPost) URLIndex = 1;
        if (isPreTextPostIDNPost) URLIndex = 2;
        if (isPreIDNPostTextPost) URLIndex = 3;
